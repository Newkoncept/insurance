...
HTMLUI.prototype.previousResultRemover = function () {
  if (document.querySelector("#result div")) {
    document.querySelector("#result div").remove();
  }
};

HTMLUI.prototype.displayQuote = function (price, make, year, level) {
  html.previousResultRemover();
...
HTMLUI.prototype.makeSelectedDisplayer = function (make) {
  switch (make) {
    case "1":
      make = "American";
      break;
...
Insurance.prototype.calculateQuote = function (make, year, level) {
  let baseAmount = 2000;
  let price;
...
Insurance.prototype.calculateMake = function (baseAmount, make) {
  let price;
  /*
...
Insurance.prototype.calculateYears = function (price, year) {
...
Insurance.prototype.calculateYearDifference = function (year) {
